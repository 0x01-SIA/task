        ...
        <div class="card-body p-4">
            <div class="job-assets-header">
                <div>
                    ...
                    <p class="text-secondary mb-0">Record materials used on site. Entries stay visible after the job closes, but worker corrections stop once the job is completed or cancelled.</p>
                </div>
            </div>
