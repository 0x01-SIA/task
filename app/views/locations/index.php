        ...
        <div class="card-body p-4 p-lg-5">
            <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
                <div>
                    ...
                    <h1 class="h3 mb-2">Customer Locations</h1>
                    <p class="text-secondary mb-0">Manage the physical sites where future field work will be performed.</p>
                </div>
                <a class="btn btn-primary" href="<?= h(app_url('/locations/create' . ($selectedCustomerId !== null ? '?customer_id=' . $selectedCustomerId : ''))) ?>">Add Location</a>
            </div>
        </div>
    </section>
        ...
        <div class="card-body p-4">
            ...
            <form method="get" action="<?= h(app_url('/locations')) ?>" class="row g-3 align-items-end">
                ...
                <?php if ($selectedCustomerId !== null): ?>
                    <div class="col-auto">
                        <a class="btn btn-outline-secondary" href="<?= h(app_url('/locations')) ?>">Clear</a>
                    </div>
                <?php endif; ?>
            </form>

            <?php if ($selectedCustomer !== null): ?>
                <p class="small text-secondary mt-3 mb-0">Showing locations for <a href="<?= h(app_url('/customers/' . $selectedCustomer['id'])) ?>"><?= h($selectedCustomer['name']) ?></a>.</p>
            <?php endif; ?>
        </div>
    </section>
                    ...
                    <table class="table align-middle mb-0">
                        ...
                        <?php foreach ($locations as $location): ?>
                            <tr>
                                ...
                                <td><?= h($location['contact_phone'] ?: 'Not provided') ?></td>
                                <td>
